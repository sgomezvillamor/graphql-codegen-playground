...
def query_get_items_database_tables_connection():
    ...
    _op_database_tables_connection_nodes_columns = _op_database_tables_connection_nodes.columns()
    _op_database_tables_connection_nodes_columns.remote_type()
    _op_database_tables_connection_nodes_columns.name()
    _op_database_tables_connection_page_info = _op_database_tables_connection.page_info()
...
def query_get_items_custom_sqltables_connection():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='GetItems_customSQLTablesConnection', variables=dict(first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    _op_custom_sqltables_connection = _op.custom_sqltables_connection(first=sgqlc.types.Variable('first'), after=sgqlc.types.Variable('after'), filter={'idWithin': ('81335c49-5edc-bbfa-77c9-c4a1cd444501', '48c19c5f-4300-07bb-17ee-1fbdf6824ff6')})
    ...
    _op_custom_sqltables_connection_nodes_columns = _op_custom_sqltables_connection_nodes.columns()
    ...
    _op_custom_sqltables_connection_nodes_columns_referenced_by_fields = _op_custom_sqltables_connection_nodes_columns.referenced_by_fields()
    _op_custom_sqltables_connection_nodes_columns_referenced_by_fields_datasource = _op_custom_sqltables_connection_nodes_columns_referenced_by_fields.datasource()
    ...
    _op_custom_sqltables_connection_nodes_columns_referenced_by_fields_datasource__as__PublishedDatasource = _op_custom_sqltables_connection_nodes_columns_referenced_by_fields_datasource.__as__(_schema.PublishedDatasource)
    ...
    _op_custom_sqltables_connection_nodes_columns_referenced_by_fields_datasource__as__EmbeddedDatasource = _op_custom_sqltables_connection_nodes_columns_referenced_by_fields_datasource.__as__(_schema.EmbeddedDatasource)
    ...
    _op_custom_sqltables_connection_nodes_tables = _op_custom_sqltables_connection_nodes.tables()
    _op_custom_sqltables_connection_nodes_tables.id()
    _op_custom_sqltables_connection_nodes_tables.name()
    _op_custom_sqltables_connection_nodes_tables_database = _op_custom_sqltables_connection_nodes_tables.database()
    ...
    _op_custom_sqltables_connection_nodes_tables_columns_connection = _op_custom_sqltables_connection_nodes_tables.columns_connection()
    ...
    _op_custom_sqltables_connection_nodes_database = _op_custom_sqltables_connection_nodes.database()
    ...
    _op_custom_sqltables_connection_page_info = _op_custom_sqltables_connection.page_info()
...
def query_get_items_published_datasources_connection():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='GetItems_publishedDatasourcesConnection', variables=dict(first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    _op_published_datasources_connection = _op.published_datasources_connection(first=sgqlc.types.Variable('first'), after=sgqlc.types.Variable('after'), filter={'idWithin': ('35d62018-68e1-6ad4-2cf0-d3ede4ee9a67', '87d9d9d8-59a8-adc3-3e06-f75c5b98ec52', 'ae8b52c9-1481-06fd-fe96-e6d4938f9fcb')})
    _op_published_datasources_connection_nodes = _op_published_datasources_connection.nodes()
    ...
    _op_published_datasources_connection_nodes_upstream_tables = _op_published_datasources_connection_nodes.upstream_tables()
    ...
    _op_published_datasources_connection_nodes_upstream_tables_database = _op_published_datasources_connection_nodes_upstream_tables.database()
    ...
    _op_published_datasources_connection_nodes_upstream_tables_columns_connection = _op_published_datasources_connection_nodes_upstream_tables.columns_connection()
    _op_published_datasources_connection_nodes_upstream_tables_columns_connection.total_count()
    _op_published_datasources_connection_nodes_fields = _op_published_datasources_connection_nodes.fields()
    ...
    _op_published_datasources_connection_nodes_fields__as__ColumnField = _op_published_datasources_connection_nodes_fields.__as__(_schema.ColumnField)
    ...
    _op_published_datasources_connection_nodes_fields__as__CalculatedField = _op_published_datasources_connection_nodes_fields.__as__(_schema.CalculatedField)
    ...
    _op_published_datasources_connection_nodes_fields__as__GroupField = _op_published_datasources_connection_nodes_fields.__as__(_schema.GroupField)
    ...
    _op_published_datasources_connection_nodes_owner = _op_published_datasources_connection_nodes.owner()
    ...
    _op_published_datasources_connection_nodes_tags = _op_published_datasources_connection_nodes.tags()
    _op_published_datasources_connection_nodes_tags.name()
    _op_published_datasources_connection_page_info = _op_published_datasources_connection.page_info()
...
def query_get_items_fields_connection():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='GetItems_fieldsConnection', variables=dict(first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    ...
    _op_fields_connection_nodes_upstream_fields = _op_fields_connection_nodes.upstream_fields()
    _op_fields_connection_nodes_upstream_fields.name()
    _op_fields_connection_nodes_upstream_fields_datasource = _op_fields_connection_nodes_upstream_fields.datasource()
    _op_fields_connection_nodes_upstream_fields_datasource.id()
    _op_fields_connection_nodes_upstream_columns = _op_fields_connection_nodes.upstream_columns()
    _op_fields_connection_nodes_upstream_columns.name()
    _op_fields_connection_nodes_upstream_columns_table = _op_fields_connection_nodes_upstream_columns.table()
...
def query_get_items_embedded_datasources_connection():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='GetItems_embeddedDatasourcesConnection', variables=dict(first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    _op_embedded_datasources_connection = _op.embedded_datasources_connection(first=sgqlc.types.Variable('first'), after=sgqlc.types.Variable('after'), filter={'idWithin': ('7437c561-4e94-0283-3462-c6205c2288cd', '797a69b1-c32a-2fd4-62aa-99989c1858a6', '79871b17-d526-17be-df59-e001f7140924', '8f5e3006-6756-8eea-4fd3-44781cea1493', '1c5653d6-c448-0850-108b-5c78aeaf6b51', '6731f648-b756-31ea-fcdd-77309dd3b0c3', '6bd53e72-9fe4-ea86-3d23-14b826c13fa5', '3f46592d-f789-8f48-466e-69606990d589', '415ddd3e-be04-b466-bc7c-5678a4b0a733', 'e9b47a00-12ff-72cc-9dfb-d34e0c65095d')})
    _op_embedded_datasources_connection_nodes = _op_embedded_datasources_connection.nodes()
    ...
    _op_embedded_datasources_connection_nodes_downstream_sheets = _op_embedded_datasources_connection_nodes.downstream_sheets()
    ...
    _op_embedded_datasources_connection_nodes_upstream_tables = _op_embedded_datasources_connection_nodes.upstream_tables()
    ...
    _op_embedded_datasources_connection_nodes_upstream_tables_database = _op_embedded_datasources_connection_nodes_upstream_tables.database()
    ...
    _op_embedded_datasources_connection_nodes_upstream_tables_columns_connection = _op_embedded_datasources_connection_nodes_upstream_tables.columns_connection()
    _op_embedded_datasources_connection_nodes_upstream_tables_columns_connection.total_count()
    _op_embedded_datasources_connection_nodes_fields = _op_embedded_datasources_connection_nodes.fields()
    ...
    _op_embedded_datasources_connection_nodes_fields__as__ColumnField = _op_embedded_datasources_connection_nodes_fields.__as__(_schema.ColumnField)
    ...
    _op_embedded_datasources_connection_nodes_fields__as__CalculatedField = _op_embedded_datasources_connection_nodes_fields.__as__(_schema.CalculatedField)
    ...
    _op_embedded_datasources_connection_nodes_fields__as__GroupField = _op_embedded_datasources_connection_nodes_fields.__as__(_schema.GroupField)
    ...
    _op_embedded_datasources_connection_nodes_upstream_datasources = _op_embedded_datasources_connection_nodes.upstream_datasources()
    ...
    _op_embedded_datasources_connection_nodes_workbook = _op_embedded_datasources_connection_nodes.workbook()
    ...
    _op_embedded_datasources_connection_nodes_workbook_owner = _op_embedded_datasources_connection_nodes_workbook.owner()
    _op_embedded_datasources_connection_nodes_workbook_owner.username()
    _op_embedded_datasources_connection_page_info = _op_embedded_datasources_connection.page_info()
...
def query_get_items_sheets_connection():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='GetItems_sheetsConnection', variables=dict(first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    ...
    _op_sheets_connection_nodes_contained_in_dashboards = _op_sheets_connection_nodes.contained_in_dashboards()
    ...
    _op_sheets_connection_nodes_workbook_owner = _op_sheets_connection_nodes_workbook.owner()
    _op_sheets_connection_nodes_workbook_owner.username()
    _op_sheets_connection_nodes_datasource_fields = _op_sheets_connection_nodes.datasource_fields()
    ...
    _op_sheets_connection_nodes_datasource_fields_datasource = _op_sheets_connection_nodes_datasource_fields.datasource()
    _op_sheets_connection_nodes_datasource_fields_datasource.id()
    _op_sheets_connection_nodes_datasource_fields_datasource.name()
    _op_sheets_connection_nodes_datasource_fields__as__ColumnField = _op_sheets_connection_nodes_datasource_fields.__as__(_schema.ColumnField)
    ...
    _op_sheets_connection_nodes_datasource_fields__as__CalculatedField = _op_sheets_connection_nodes_datasource_fields.__as__(_schema.CalculatedField)
    ...
    _op_sheets_connection_nodes_datasource_fields__as__GroupField = _op_sheets_connection_nodes_datasource_fields.__as__(_schema.GroupField)
    ...
    _op_sheets_connection_nodes_datasource_fields__as__DatasourceField = _op_sheets_connection_nodes_datasource_fields.__as__(_schema.DatasourceField)
    ...
    _op_sheets_connection_nodes_datasource_fields__as__DatasourceField_remote_field__as__ColumnField = _op_sheets_connection_nodes_datasource_fields__as__DatasourceField_remote_field.__as__(_schema.ColumnField)
    ...
    _op_sheets_connection_nodes_datasource_fields__as__DatasourceField_remote_field__as__CalculatedField = _op_sheets_connection_nodes_datasource_fields__as__DatasourceField_remote_field.__as__(_schema.CalculatedField)
    ...
    _op_sheets_connection_nodes_datasource_fields__as__DatasourceField_remote_field__as__GroupField = _op_sheets_connection_nodes_datasource_fields__as__DatasourceField_remote_field.__as__(_schema.GroupField)
...
def query_get_items_workbooks_connection():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='GetItems_workbooksConnection', variables=dict(first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    _op_workbooks_connection = _op.workbooks_connection(first=sgqlc.types.Variable('first'), after=sgqlc.types.Variable('after'), filter={'projectNameWithin': ('project_test2',)})
    ...
    _op_workbooks_connection_nodes_dashboards = _op_workbooks_connection_nodes.dashboards()
    _op_workbooks_connection_nodes_dashboards.id()
    _op_workbooks_connection_nodes_embedded_datasources = _op_workbooks_connection_nodes.embedded_datasources()
...
class Query:
    get_items_custom_sqltables_connection = query_get_items_custom_sqltables_connection()
    get_items_database_tables_connection = query_get_items_database_tables_connection()
    get_items_embedded_datasources_connection = query_get_items_embedded_datasources_connection()
    get_items_fields_connection = query_get_items_fields_connection()
    get_items_published_datasources_connection = query_get_items_published_datasources_connection()
